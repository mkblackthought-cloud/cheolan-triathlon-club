...
function adminPage() {
  ...
  const teamAdminLink = document.createElement('a'); teamAdminLink.href = '#teamadmin'; teamAdminLink.className = 'btn orange full'; teamAdminLink.textContent = '팀 생성 · 배정 · 팀장 관리'; main.querySelector('.hero').insertAdjacentElement('afterend', teamAdminLink); const memberAdminLink = document.createElement('a'); memberAdminLink.href = '#membersadmin'; memberAdminLink.className = 'btn outline full'; memberAdminLink.style.marginTop = '10px'; memberAdminLink.textContent = '가입 회원 목록'; teamAdminLink.insertAdjacentElement('afterend', memberAdminLink);

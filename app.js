...
function adminPage() {
  ...
  const adminTabs = document.createElement('div'); adminTabs.className = 'tabs'; adminTabs.innerHTML = '<a class="tab active" href="#admin">점수 설정</a><a class="tab" href="#membersadmin">가입 회원 목록</a>'; main.querySelector('.hero').insertAdjacentElement('afterend', adminTabs); const teamAdminLink = document.createElement('a'); teamAdminLink.href = '#teamadmin'; teamAdminLink.className = 'btn orange full'; teamAdminLink.textContent = '팀 생성 · 배정 · 팀장 관리'; adminTabs.insertAdjacentElement('afterend', teamAdminLink);
